    ...
    <div
        ...
        <div class="w-full overflow-x-scroll px-4 md:overflow-x-hidden">
            <table role="table" class="w-full overflow-x-scroll">
                ...
                @foreach($secteurActivites as $secteurActivite)
                    <tr role="row">
                        ...
                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right flex items-center justify-end h-full">
                        <a href="{{ route('secteur-activites.show', [$secteurActivite->id]) }}" class="group relative inline-block">
                            ...
                            <a href="{{ route('secteur-activites.edit', [$secteurActivite->id]) }}" class="group relative inline-block">
                                <button class="focus:outline-none">
                            ...
                            {!! Form::open(['route' => ['secteur-activites.destroy', $secteurActivite->id], 'method' => 'delete']) !!}
            ...
            <div class="mb-4 flex justify-center space-x-4 mt-7">
                {{ $secteurActivites->links('vendor.pagination.custom') }}
            </div>
        </div>
    </div>
</div>
