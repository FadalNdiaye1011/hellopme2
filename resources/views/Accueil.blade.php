...
<!-- Mirrored from www.georisgroup.com/ by HTTrack Website Copier/3.x [XR&CO'2014], Mon, 30 Sep 2024 11:48:10 GMT -->

<head>
    <meta charset="utf-8">
    <meta name="viewport" content="user-scalable=0, initial-scale=1.0, maximum-scale=1.0, width=device-width">
    <meta name="description" content="Bienvenue sur GEORIS GROUP, leader des solutions métier depuis 2008 en Afrique. Georis Group SA est spécialisé dans le développement d'applications...">
    <meta name="author" content="Georis Group">
    <meta name="keywords" content="Géolocalisation, Sénégal, Balises, Gestion carburant">
    ...
    <link rel="stylesheet" type="text/css" href="{{ asset('AccueilCss/style.css') }}" />
    <link href="{{ asset('AccueilCss/style-responsive.css') }}" rel="stylesheet" />
    <link rel="stylesheet" type="text/css" href="{{ asset('AccueilCss/parallax-slider/parallax-slider.css') }}" />
    <script type="text/javascript" src="{{ asset('Accueilljs/parallax-slider/modernizr.custom.28468.js') }}">
    </script>
...
<body>
        ...
        <div class="da-slide">
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        <h2>
                            Trouvez facilement des opportunités <br>
                            pour votre PME.
                        </h2>
                        <p>
                            Découvrez notre application web qui vous permet d'accéder à de nouveaux marchés et partenaires. Connectez-vous dès maintenant et propulsez votre entreprise vers de nouveaux horizons! <br>
                            <br>
                            <a href="/login">
                                <button type="button" class="btn" data-toggle="button" aria-pressed="false" autocomplete="off" style="background: white; color:#677B44">
                                    Se connecter
                                </button>
                            </a>
                            <a href="/register">
                                <button type="button" class="btn btn-primary" data-toggle="button" aria-pressed="false" autocomplete="off" style="background: #677B44; color:">
                                    S'inscrire
                                </button>
                            </a>
                        </p>
                        ...
                        <div class="device-wrapper">
                            <div class="da-img" data-device="iPhoneX" data-orientation="portrait" data-color="black">
                                <div class="">
                                    <video muted="muted" autoplay="" loop="" style="max-width: 100%; height: 80%;margin-bootom:2rem">
                                        <source src="{{ asset('images/demo-screen.mp4') }}" src="assets/img/demo-screen.mp4" type="video/mp4" />
                                    </video>
                                </div>
                            </div>
                        </div>
            ...
            <div class="container">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <p>
                            Accédez facilement à de nouveaux marchés et partenaires grâce à notre application mobile intuitive. Téléchargez-la dès maintenant et propulsez votre entreprise vers de nouveaux horizons! <br>
                            <br>
                            <a class="me-lg-3 mb-4 mb-lg-0" href="#!">
                                <img class="app-badge" src="{{ asset('images/google-play-badge.svg') }}" alt="..." />
                            </a>
                            <a href="#!" class="me-lg-3 mb-4 mb-lg-0">
                                <img class="app-badge" src="{{ asset('images/app-store-badge.svg') }}" alt="..." />
                            </a>
                        </p>
    ...
    <section id="typeFinacement" class="content-body-home bg-light py-5">
        <div class="container">
            @if($financements->count() > 0)
            <h2 class="sub-title text-center mb-4">🌟 Explorez les Financements par Type 🌟</h2>
            <div class="row group-card g-3">
                @foreach ($typefinances as $typefinance)
                <div class="col-12 col-md-6 col-lg-4 mb-4">
                    <div class="card shadow-sm border-0 rounded">
                        <div class="text-white card-header text-center" style="background: #677B44;">
                            <h5 class="card-title">{{ $typefinance->libelle }}</h5>
                        </div>
                        <div class="card-body text-center">
                            <a href="{{ route('typeFinance.list', [$typefinance->id]) }}" class="btn text-white mt-3" style="background: black;">
                                En savoir plus
                            </a>
                        </div>
                    </div>
            ...
            <div class="text-center mt-4">
                <a class="btn text-white" style="background:#677B44" href="{{ route('opportunities.search', ['type' => 'all']) }}">Voir toutes les opportunités</a>
            </div>
            @endif
        </div>
    </section>
    ...
    <section id="Opportunites_par_pays" class="section-opportunite-pays">
        <div class="container">
            <p class="sub-title" style="color:white">Explorez les opportunités par pays</p>
            <div class="row">
    ...
    <!-- A propos -->
    <section id="a_propos" class="py-5 bg-light">
        <div class="container">
            <div class="row gy-3 gy-md-4 align-items-lg-center">
                <div class="col-12 col-lg-6">
                    <img class="img-fluid rounded shadow" loading="lazy" src="{{ asset('images/a_propos_de_nous.jpg') }}" alt="À propos de nous">
                </div>
                <div class="col-12 col-lg-6">
                    <h2 class="mb-4 text-center text-lg-start">À Propos de Nous</h2>
                    <p class="lead fs-4 text-secondary mb-4">Nous sommes dédiés à accompagner les petites et moyennes entreprises dans leur quête d'opportunités et de croissance. Notre mission est de rendre l'accès à des ressources et des partenaires plus simple et rapide.</p>
                    <p class="mb-5">Avec notre plateforme, les entreprises peuvent découvrir de nouvelles possibilités, trouver des solutions sur mesure et se développer dans un environnement en constante évolution.</p>
                    <div class="row gy-4">
                        <div class="col-12 col-md-6">
                            <div class="d-flex align-items-start">
                                <div class="me-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#677B44" class="bi bi-gear-fill" viewBox="0 0 16 16">
                                        <path d="M9.405 1.05c-.413-1.4-2.397-1.4-2.81 0l-.1.34a1.464 1.464 0 0 1-2.105.872l-.31-.17c-1.283-.698-2.686.705-1.987 1.987l.169.311c.446.82.023 1.841-.872 2.105l-.34.1c-1.4.413-1.4 2.397 0 2.81l.34.1a1.464 1.464 0 0 1 .872 2.105l-.17.31c-.698 1.283.705 2.686 1.987 1.987l.311-.169a1.464 1.464 0 0 1 2.105.872l.1.34c.413 1.4 2.397 1.4 2.81 0l.1-.34a1.464 1.464 0 0 1 2.105-.872l.31.17c1.283.698 2.686-.705 1.987-1.987l-.169-.311a1.464 1.464 0 0 1 .872-2.105l.34-.1c1.4-.413 1.4-2.397 0-2.81l-.34-.1a1.464 1.464 0 0 1-.872-2.105l.17-.31c.698-1.283-.705-2.686-1.987-1.987l-.311.169a1.464 1.464 0 0 1-2.105-.872l-.1-.34zM8 10.93a2.929 2.929 0 1 1 0-5.86 2.929 2.929 0 0 1 0 5.858z" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 class="h5 mb-2">Notre Mission</h3>
                                    <p class="text-secondary mb-0">Faciliter la connexion entre les PME et les opportunités qui leur correspondent, en leur offrant les outils nécessaires pour prospérer.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-12 col-md-6">
                            <div class="d-flex align-items-start">
                                <div class="me-4">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="32" height="32" fill="#677B44" class="bi bi-fire" viewBox="0 0 16 16">
                                        <path d="M8 16c3.314 0 6-2 6-5.5 0-1.5-.5-4-2.5-6 .25 1.5-1.25 2-1.25 2C11 4 9 .5 6 0c.357 2 .5 4-2 6-1.25 1-2 2.729-2 4.5C2 14 4.686 16 8 16Zm0-1c-1.657 0-3-1-3-2.75 0-.75.25-2 1.25-3C6.125 10 7 10.5 7 10.5c-.375-1.25.5-3.25 2-3.5-.179 1-.25 2 1 3 .625.5 1 1.364 1 2.25C11 14 9.657 15 8 15Z" />
                                    </svg>
                                </div>
                                <div>
                                    <h3 class="h5 mb-2">Nos Valeurs</h3>
                                    <p class="text-secondary mb-0">Innovation, simplicité et engagement. Nous croyons en des solutions efficaces et accessibles à toutes les entreprises, quelle que soit leur taille.</p>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script src="{{ asset('Accueilljs/jquery.js') }}">
    </script>



    <script type="text/javascript" src="{{ asset('Accueilljs/parallax-slider/jquery.cslider.js') }}">
    </script>
