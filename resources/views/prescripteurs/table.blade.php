        ...
        <div class="flex-auto block py-8 pt-6 px-9">
          <div class="overflow-x-auto">
            <table class="w-full my-0 align-middle text-dark border-neutral-200">
              <thead class="align-bottom">
                <tr class="font-semibold text-[0.95rem] text-secondary-dark">
                  ...
                  <th class="pb-3 text-start min-w-[100px]">Titre Responsable</th>
              ...
              @foreach($prescripteurs as $prescripteur)
                ...
                <tr class="border-b border-dashed last:border-b-0">
                  ...
                  <td class="p-3 pr-0">
                    <span class="font-semibold text-light-inverse text-md/normal">{{ $prescripteur->titre_responsable }}</span>
                  </td>
                  <td class="p-3 pr-0">
                  ...
                  <a href="{{ route('prescripteurs.show', [$prescripteur->id]) }}" class="group relative inline-block">
                                ...
                                >
                                    ...
                                    {!! Form::open(['route' => ['prescripteurs.destroy', $prescripteur->id], 'method' => 'delete']) !!}
            ...
            <div class="mb-4 flex justify-center space-x-4 mt-7">
                     {{ $prescripteurs->links('vendor.pagination.custom') }}
                    </div>
          </div>
        </div>
      </div>
