              ...
              >
                ...
                <div class="block w-full overflow-x-auto">
                  ...
                  >
                    ...
                    <tbody>
                    @foreach($rateTariffs as $rateTariff)
                    @php
                    ...
                    @endphp
                      <tr>
                        ...
                        <td class="border-t-0 px-6 align-middle border-l-0 border-r-0 text-xs whitespace-nowrap p-4 text-right flex items-center justify-start h-full">
                            <a href="{{ route('rate-tariffs.show', [$rateTariff->id]) }}" class="group relative inline-block">
                                ...
                                >
                                    ...
                                    <a href="{{ route('rate-tariffs.edit', [$rateTariff->id]) }}"
                                    ...
                                    {!! Form::open(['route' => ['rate-tariffs.destroy', $rateTariff->id], 'method' => 'delete']) !!}
                    ...
                    <div class="mb-4 flex justify-center space-x-4 mt-7">
                        {{ $rateTariffs->links('vendor.pagination.custom') }}
                    </div>
                </div>
