        ...
        <div class="rounded-t mb-0 px-4 py-3 border-0">
            <div class="flex flex-wrap items-center">
                <div class="relative w-full px-4 max-w-full flex-grow flex-1">
                    <h3 class="font-semibold text-lg text-blueGray-700">Type Finances</h3>
                </div>
            </div>
        </div>
            ...
            <table class="items-center w-full border-collapse">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td class="">
                            <a href="{{ route('type-finances.show', [$type->id]) }}" class="group relative inline-block">
                            ...
                            <a href="{{ route('type-finances.edit', [$type->id]) }}" class="group relative inline-block">
                                <button class="focus:outline-none">
